var Cell2 =  cc.Sprite.extend({
    ...
    ctor:function(fileName, rect, rotated){
        ...
        var mySprite = new EffectNode_two(res.effect6);
        mySprite.x =35;
        mySprite.y =35;
    ...
    LevelRunAction:function(){
        ...
        for(var i=1;i<4;i++){
            var frameName=res["Cell2_"+this.LevelNum+"_"+i];
    ...
    addLevelUpClose:function(){
        ...
        var LevelUp = new cc.MenuItemImage(res.Level_up,res.Level_up_down,function(){
            ...
            if(this.LevelNum<=3){
                ...
                this.setTexture("res/mainScene/cell2-"+this.LevelNum+"-1.png");
                this.stopAllActions();
                this.LevelRunAction();
            }
            if(this.LevelNum>3){
