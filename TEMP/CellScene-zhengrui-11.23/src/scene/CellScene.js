/**
 * Created by 郑蕊 on 2016/11/23.
 */
var CellLayer = cc.Layer.extend({
    ctor:function () {
        this._super();
        var size = cc.winSize;
        //图鉴背景图层
        ...
        //点击左边，在右边显示的细胞图片
        var cellone = new cc.Sprite(res.pokecell);
        //缩小
        ...
        title4.setFontSize(size.width*0.03);
        title4.setFontFillColor(cc.color.BLACK);
        title4.x = blackboard .width * 0.35;
        ...
        //细胞种类
      var cell1= new cc.MenuItemImage(res.cell1, function () {
            //详情介绍接口
            this.director.runScene(new MainScene());
        }, this);
        var menu1 = new cc.Menu(cell1);
        menu1.x = cellgridItem1.width*0.5;
        menu1.y = cellgridItem1.height * 0.5;
        cellgridItem1.addChild(menu1);

        var cell2= new cc.MenuItemImage(res.cell2, function () {
            //详情介绍接口
            this.director.runScene(new MainScene());
        }, this);
        var menu2 = new cc.Menu(cell2);
        menu2.x = cellgridItem2.width*0.5;
        menu2.y = cellgridItem2.height * 0.5;
        cellgridItem2.addChild(menu2);

        var cell3= new cc.MenuItemImage(res.cell3, function () {
            //详情介绍接口
            this.director.runScene(new MainScene());
        }, this);
        var menu3 = new cc.Menu(cell3);
        menu3.x = cellgridItem3.width*0.5;
        menu3.y = cellgridItem3.height * 0.5;
        cellgridItem3.addChild(menu3);

        var cell4= new cc.MenuItemImage(res.cell4, function () {
            //详情介绍接口
            this.director.runScene(new MainScene());
        }, this);
        var menu4 = new cc.Menu(cell4);
        menu4.x = cellgridItem4.width*0.5;
        menu4.y = cellgridItem4.height * 0.5;
        cellgridItem4.addChild(menu4);

        var cell5= new cc.MenuItemImage(res.cell5, function () {
            //详情介绍接口
            this.director.runScene(new MainScene());
        }, this);
        var menu5 = new cc.Menu(cell5);
        menu5.x = cellgridItem5.width*0.5;
        menu5.y = cellgridItem5.height * 0.5;
        cellgridItem5.addChild(menu5);

        var cell6= new cc.MenuItemImage(res.cell6, function () {
            //详情介绍接口
            this.director.runScene(new MainScene());
        }, this);
        var menu6 = new cc.Menu(cell6);
        menu6.x = cellgridItem6.width*0.5;
        menu6.y = cellgridItem6.height * 0.5;
        cellgridItem6.addChild(menu6);

        var cell7= new cc.MenuItemImage(res.cell7, function () {
            //详情介绍接口
            this.director.runScene(new MainScene());
        }, this);
        var menu7 = new cc.Menu(cell7);
        menu7.x = cellgridItem7.width*0.5;
        menu7.y = cellgridItem7.height * 0.5;
