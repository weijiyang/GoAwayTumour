/* 2016-11-23   曹阳   创建 */
var MainLayer3 = cc.Layer.extend({
    pus : null,
    sprite:null,
    stars:[],
    tiledMap            : null, // 瓦片地图
    ...
    ctor : function()
    {
        ...
        var protect = new cc.Sprite(res.protect3);
        this.pro = protect;
...
// 波次血量翻倍
    ...
    showTopBg:function(){
        ...
        mianyizhi.y = cc.winSize.height*0.93;
    ...
    loadTiledMap : function(){
        var tileMap=new cc.TMXTiledMap(res.BGS2);
...
cc.director.resume();
    ...
    initwinTc : function()
    {
        ...
        var newCellItem = new cc.MenuItemImage(res.cell52,res.cell52, function () {
            cc.director.resume();
