/* 2016-11-23   曹阳   创建 */
var MainLayer1 = cc.Layer.extend({
    pus : null,
    sprite:null,
    stars:[],
    tiledMap            : null, // 瓦片地图
    ...
    ctor : function()
    {
        ...
        var protect = new cc.Sprite(res.protect1);
        this.pro = protect;
...
// 波次血量翻倍
    ...
    showTopBg:function(){
        ...
        // allMonsterTimes.setFontFillColor(cc.color.BLACK);
        ...
        // NowTimes.setFontFillColor(cc.color.BLACK);
...
// cc.log(data);
        ...
        switch (data.name){
            case "Bottle":
                ...
                node = new Bottle("res/mainScene/cell6-1-1.png");
                break;
            case "Cell1":
                towerData.scope = 300;
                towerData.bulletSpeed = 40;
                node = new Cell1("res/mainScene/cell1-1-1.png");
                break;
            case "Cell3":
                towerData.scope = 300;
                towerData.bulletSpeed = 40;
                node = new  Cell3("res/mainScene/cell5-1-1.png");
                break;
            default :
...
cc.director.resume();
    ...
    initwinTc : function()
    {
        ...
        var newCellItem = new cc.MenuItemImage(res.cell32,res.cell32, function () {
            cc.director.resume();
