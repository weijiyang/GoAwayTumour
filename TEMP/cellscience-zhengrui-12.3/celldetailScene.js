...
var CellDetailLayer = cc.Layer.extend({
    ...
    ctor:function () {
        ...
        //点击左边，右边显示细胞文字描述
        var content = new cc.LabelTTF("详情",'',50);
        content.weight=100;
        content.x=blackboard  .width * 0.5;
        content.y=blackboard .height*0.85;
        blackboard .addChild(content);
        content.runAction(cc.hide());
        ...
        title2.x = blackboard .width * 0.48;
...
*/
        ...
        var xuexi=new cc.MenuItemImage(res.science11,res.science12,function () {
        },this);
        var fanhui=new cc.MenuItemImage(res.science21,res.science22,function () {
        },this);
        var toggleItem=new cc.MenuItemToggle(xuexi,fanhui,function () {
            cc.log(toggleItem.getSelectedIndex());
            if(0==toggleItem.getSelectedIndex()){
            content.runAction(cc.hide());
                title1.runAction(cc.show());
                title2.runAction(cc.show());
                title3.runAction(cc.show());
                title4.runAction(cc.show());

            }else{
                content.runAction(cc.show());
                title1.runAction(cc.hide());
                title2.runAction(cc.hide());
                title3.runAction(cc.hide());
                title4.runAction(cc.hide());


            }
        },this);
        if("YES"==ls.getItem("isMusicOn")){
            //toggleMenuItem.setSelectedIndex(0);

        }
        else if(0==ls.getItem("isMusicOn")){
            //用户以前设置的是开状态(用户之前把声音打开了，等再次打开声音还是打开的)
            toggleItem.setSelectedIndex(0);
        }else if(1==ls.getItem("isMusicOn")){
            //用户以前设置的是开状态(用户之前把声音关了，等再次打开声音还是关闭的)
        ...
        //点我学习
        var title6= new cc.MenuItemImage(res.science11,res.science12, function () {
            //blackboard.setTexture(res.blackboard);
            title1.setString("淋巴细胞：");
            title2.setString("由淋巴器官产生，");
            title3.setString("白细胞的一种，机");
            title4.setString("有体免疫应答功能");

            //点我返回
            var sciencereturn = new cc.MenuItemImage(res.science21,res.science22,function () {
                //返回初次场景
            },this);
            title6.runAction(cc.hide());
            sciencereturn.x=blackboard.width*0.5;
            sciencereturn.y=blackboard.height*0.15;
            var menu=new cc.Menu(sciencereturn);
            menu.x = 0;
            menu.y = 0;
            blackboard.addChild(menu);
        }, this);
        title6.x = blackboard.width*0.5;
        title6.y = blackboard.height*0.15;
        var menu = new cc.Menu(title6);
        menu.x = 0;
        menu.y = 0;
        blackboard.addChild(menu);
        ...
        var cell1= new cc.MenuItemImage(res.cell12,res.cell1, function () {
            ...
            title1.setString("淋巴细胞");
            title2.setString("攻击范围：70");
            title3.setString("攻击伤害：40");
            title4.setString("攻击速度：02");
        ...
        var cell2= new cc.MenuItemImage(res.cell22, res.cell2, function () {
            ...
            var title6= new cc.MenuItemImage(res.science11,res.science12, function () {
                //blackboard.setTexture(res.blackboard);
                title1.setString("粒细胞：");
                title2.setString("在血液中有十分重");
                title3.setString("要的趋化作用，吞");
                title4.setString("噬作用和杀菌作用");
        ...
        var cell3= new cc.MenuItemImage(res.cell32, res.cell3, function () {
            ...
            var title6= new cc.MenuItemImage(res.science11,res.science12, function () {
                //blackboard.setTexture(res.blackboard);
                title1.setString("红细胞：");
                title2.setString("是血液中数量最多");
                title3.setString("的一种血细胞，形");
                title4.setString("如圆盘，中间下凹");
        ...
        var cell4= new cc.MenuItemImage(res.cell42, res.cell4, function () {
            ...
            var title6= new cc.MenuItemImage(res.science11,res.science12, function () {
                //blackboard.setTexture(res.blackboard);
                title1.setString("吞噬细胞：");
                title2.setString("吞噬细胞的功能有");
                title3.setString("和病菌接触，吞入");
                title4.setString("，杀死和破坏病菌");
        ...
        var cell5= new cc.MenuItemImage(res.cell52, res.cell5, function () {
            ...
            var title6= new cc.MenuItemImage(res.science11,res.science12, function () {
                //blackboard.setTexture(res.blackboard);
                title1.setString("NK细胞：");
                title2.setString("与抗肿瘤、抗病毒");
                title3.setString("感染和免疫调节有");
                title4.setString("关，从骨髓中衍生");
        ...
        var cell6= new cc.MenuItemImage(res.cell62, res.cell6, function () {
            ...
            var title6= new cc.MenuItemImage(res.science11,res.science12, function () {
                //blackboard.setTexture(res.blackboard);
                title1.setString("上皮细胞：");
                title2.setString("是位于皮肤或腔道");
                title3.setString("表层的细胞，具有");
                title4.setString("保护和吸收的作用");
        ...
        var cell7= new cc.MenuItemImage(res.cell72, res.cell7, function () {
            ...
            var title6= new cc.MenuItemImage(res.science11,res.science12, function () {
                //blackboard.setTexture(res.blackboard);
                title1.setString("浆细胞：");
                title2.setString("又称效应B细胞，");
                title3.setString("有合成、贮存抗体");
                title4.setString("即免疫球蛋白功能");
