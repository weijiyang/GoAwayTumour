...
var LevelLayer = cc.Layer.extend({
    ...
    ctor:function () {
        ...
        //1
        var Sprite1 = new myChoose(res.stagepoint_adv01);
        Sprite1.x = size.width*0.15;
        Sprite1.y = size.height*0.45;
        Sprite1.tag = 1;
        this.addChild(Sprite1);

        var star_1 = new cc.Sprite(res.star4);
        star_1.x = 55;
        star_1.y = 250;
        Sprite1.addChild(star_1);
        var star_2 = new cc.Sprite(res.star5);
        star_2.x = 130;
        star_2.y = 280;
        Sprite1.addChild(star_2);
        var star_3 = new cc.Sprite(res.star6);
        star_3.x = 205;
        star_3.y = 250;
        Sprite1.addChild(star_3);

        //2
        var Sprite2 = new myChoose(res.stagepoint_adv02);
        Sprite2.x = size.width*0.45;
        Sprite2.y = size.height*0.45;
        Sprite2.tag = 2;
        this.addChild(Sprite2);

        var star_4 = new cc.Sprite(res.star4);
        star_4.x = 55;
        star_4.y = 250;
        Sprite2.addChild(star_4);
        var star_5 = new cc.Sprite(res.star5);
        star_5.x = 130;
        star_5.y = 280;
        Sprite2.addChild(star_5);
        var star_6 = new cc.Sprite(res.star6);
        star_6.x = 205;
        star_6.y = 250;
        Sprite2.addChild(star_6);

        //3
        var Sprite3 = new myChoose(res.stagepoint_adv03);
        Sprite3.x = size.width*0.75;
        Sprite3.y = size.height*0.45;
        Sprite3.tag = 3;
        this.addChild(Sprite3);

        var star_7 = new cc.Sprite(res.star4);
        star_7.x = 55;
        star_7.y = 250;
        Sprite3.addChild(star_7);
        var star_8 = new cc.Sprite(res.star5);
        star_8.x = 130;
        star_8.y = 280;
        Sprite3.addChild(star_8);
        var star_9 = new cc.Sprite(res.star6);
        star_9.x = 205;
        star_9.y = 250;
        Sprite3.addChild(star_9);

        var tishiItem = new cc.MenuItemImage(res.jt,res.jt,function(){
            cc.director.runScene(new cc.TransitionSlideInR(0.5,new LevelScene2()));
        },this);
        var tishiMenu = new cc.Menu(tishiItem);
        tishiMenu.x = cc.winSize.width*0.95;
