...
var TumourLayer = cc.Layer.extend({
    ctor:function () {
        ...
        //细胞种类
        var cell1= new cc.MenuItemImage(res.tumour1, function () {
            //详情介绍接口
        ...
        var cell2= new cc.MenuItemImage(res.tumour2, function () {
            //详情介绍接口
            this.director.runScene(new MainScene());
        }, this);
        ...
        var cell3= new cc.MenuItemImage(res.tumour3, function () {
            //详情介绍接口
            this.director.runScene(new MainScene());
        }, this);
        ...
        var cell4= new cc.MenuItemImage(res.tumour4, function () {
            //详情介绍接口
            this.director.runScene(new MainScene());
        }, this);
        ...
        var cell5= new cc.MenuItemImage(res.tumour5, function () {
            //详情介绍接口
            this.director.runScene(new MainScene());
        }, this);
        ...
        var cell6= new cc.MenuItemImage(res.tumour6, function () {
            //详情介绍接口
            this.director.runScene(new MainScene());
        }, this);
        ...
        var cell7= new cc.MenuItemImage(res.tumour7, function () {
            //详情介绍接口
            this.director.runScene(new MainScene());
        }, this);
